node {
    ...
    stage('Staging') {
		...
		*/
	    emailext attachLog: true, body: 'hi this is jenkins build email Please go to console output of ${env.BUILD_NUMBER} to approve or Reject. http://35.177.175.56:8080/ you can use  the following credentials to login to your account Username : Manager , Password: admin', subject: 'Jenkins job', to: 'saudjunaid96@gmail.com'
